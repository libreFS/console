                ...
                help={
                  <Fragment>
                    <Box sx={{ paddingTop: "10px" }}>
                      For each write operation to the bucket, libreFS checks all
                      configured replication rules for the bucket and applies
                      the matching rule with highest configured priority.
                    </Box>
                    <Box sx={{ paddingTop: "10px" }}>
                      libreFS supports enabling replication of existing objects in
                      a bucket.
                    </Box>
                    <Box sx={{ paddingTop: "10px" }}>
                      libreFS does not enable existing object replication by
