  ...
  return (
    <Fragment>
      ...
      <p>
        ...
        with libreFS source code or at{" "}
        {makeLink(
      ...
      <p>
        When you host or distribute libreFS over a network, the AGPL v3 applies to
        you. Any distribution or copying of libreFS software modified or not has
      ...
      <h2>Making combined or derivative works of libreFS</h2>
      <p>
        Creating combined or derivative works of libreFS requires all such works
        to be released under the same license.
      </p>
      <p>
        If libreFS source code is included in the same executable file, they are
      ...
      <p>
        Merely aggregating libreFS software into your distribution does not
      ...
      <p>
        ...
        for legal advice. Purchasing a commercial license from libreFS removes the
        GNU AGPL v3 obligations from libreFS software.
      </p>
    </Fragment>
  );
};
